 ...
 */
public class ShapeletTransformWithSample extends SimpleBatchFilter {
	 ...
	 */
	public ShapeletTransformWithSample() {
	 ...
	 * @param shapes
	 */
	public ShapeletTransformWithSample(ArrayList<Shapelet> shapes) {
		this();
	 ...
	 */
	public ShapeletTransformWithSample(int k) {
	 ...
	 */
	public ShapeletTransformWithSample(int k, int minShapeletLength, int maxShapeletLength) {
	 ...
	 */
	public ShapeletTransformWithSample(int k, int minShapeletLength, int maxShapeletLength, weka.core.shapelet.QualityMeasures.ShapeletQualityChoice qualityChoice) {
	 ...
	 * @throws Exception
	 */
	public static ShapeletTransformWithSample createFilterFromFile(String fileName) throws Exception {
	 ...
	 * @throws Exception
	 */
	public static ShapeletTransformWithSample createFilterFromFile(String fileName, int maxShapelets) throws Exception {

		File input = new File(fileName);
		Scanner scan = new Scanner(input);
		scan.useDelimiter("\n");

		ShapeletTransformWithSample sf = new ShapeletTransformWithSample();
...
//			System.out.println(accuracy);
			...
			Logger.getLogger(ShapeletTransformWithSample.class.getName()).log(Level.SEVERE, null, ex);
		}
	}
}
